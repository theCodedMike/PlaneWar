...
namespace UI
{
    public class MallCategoryView : MonoBehaviour, IPointerClickHandler
    {
        public Action<MallCategoryView> OnCategorySelected;
        ...
        {
            image.color = new Color32(119, 100, 156, 255);
        }
